      ...
      {permissionsModalCustomer && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4 overflow-y-auto">
          <div className="bg-slate-900 border border-emerald-500/40 rounded-3xl p-6 w-full max-w-2xl text-slate-100 font-mono-code text-xs shadow-[0_0_60px_rgba(16,185,129,0.2)] my-8">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2.5 bg-slate-950 p-3 rounded-xl border border-slate-800 mb-4">
              <span className="text-slate-400 text-[11px] font-bold uppercase">ACCESS CONTROLS:</span>
              <div className="flex flex-wrap items-center gap-2">
                <button
                  type="button"
                  onClick={() => handleBulkPanelPerm(permissionsModalCustomer.id || permissionsModalCustomer.customer_id, 'unlock_all')}
                  className="px-3 py-1.5 rounded-lg bg-emerald-950 hover:bg-emerald-900 text-emerald-300 border border-emerald-500/40 font-bold flex items-center gap-1.5 cursor-pointer text-xs"
                >
                  <Unlock className="w-3.5 h-3.5" />
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-lg bg-rose-950 hover:bg-rose-900 text-rose-300 border border-rose-500/40 font-bold flex items-center gap-1.5 cursor-pointer text-xs"
                >
                  <Lock className="w-3.5 h-3.5" />
                  <span>LOCK ALL</span>
                </button>
                <button
                  ...
                  onClick={() => {
                    showToast('Customer permissions updated successfully.');
                    setPermissionsModalCustomer(null);
                  }}
                  className="px-4 py-1.5 rounded-lg bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold flex items-center gap-1.5 cursor-pointer text-xs shadow-[0_0_15px_rgba(0,242,254,0.3)]"
                >
            ...
            <div className="flex items-center justify-end gap-2.5 pt-4 border-t border-slate-800 mt-4">
              ...
              <button
                ...
                className="px-5 py-2 rounded-xl bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-bold transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] cursor-pointer text-xs"
              >
                SAVE PERMISSIONS
              </button>
            </div>
